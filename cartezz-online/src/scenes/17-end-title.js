// STUB
// Placeholder for shot 17 'end-title' (illustrated). The scene agent replaces this whole file.
FILM.scene({
  id: 'end-title',
  draw(ctx, t, info) {
    ...
    L.text(ctx, info.shot.title || 'end-title', 540, 1420, { size: 44, align: 'center', color: P.ink });
    L.text(ctx, 'end-title', 540, 1480, { size: 30, align: 'center', color: P.inkSoft });
